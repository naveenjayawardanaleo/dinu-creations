...
<body>
    ...
    <div id="pq-loading">
        <div id="pq-loading-center">
            <img src="img/dinu-creations-logo.png" alt="">
        </div>
    </div>
    <!--Loading End -->
                ...
                <div class="row flex-row-reverse">
                    <div class="col-md-6 text-right">
                        <div class="pq-header-social text-right">
                            <ul>
                                <li><a href="https://web.facebook.com/profile.php?id=61556125034605" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
                    ...
                    <div class="col-md-6">
                        <div class="pq-header-contact ">
                            <ul>
                                <li>
                                    <a href="tel:+180045647824"><i class="fas fa-phone-flip fa-rotate-90"></i><span>+94
                                            112 802 330</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="mailto:dinucreation7@gmail.com"><i class="fas fa-envelope"></i><span>dinucreation7@gmail.com</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <nav class="navbar navbar-expand-lg navbar-light">
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <div id="pq-menu-contain" class="pq-menu-contain">
                                    <ul id="pq-main-menu" class="navbar-nav ml-auto px-3">
                            ...
                            <a href="contact.php" class="pq-button">
                                <div class="pq-button-block">
                                    ...
                                    <span class="pq-button-text">Get a
                                        Quote</span>
                                </div>
                            </a>
